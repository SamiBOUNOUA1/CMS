export const ALL_PERMISSIONS = [
  ...
  'update_flow_status',
  'manage_event_materials',
  'check_event_materials',
  'view_calendar',
  'view_inventory',
  'manage_inventory',
  'view_suppliers',
...
export const DEFAULT_PERMISSIONS: Record<string, PermissionsMap> = {
  admin: {
    ...
    manage_event_materials: true,
    check_event_materials:  true,
    view_calendar:          true,
    view_inventory:         true,
